...
from monitoring import (
    get_cpu_usage, get_memory_usage, get_disk_io,
    get_network_io, main, PSUTIL_AVAILABLE
)
        ...
        with patch('monitoring.PSUTIL_AVAILABLE', False):
            with patch('builtins.open', mock_open(read_data='cpu  100 0 50 25 0 0 0 0 0 0\n')):
                with patch('time.sleep'):
                    ...
                    with patch('builtins.open', mock_open(read_data='cpu  200 0 100 50 0 0 0 0 0 0\n')):
...
"""
    ...
    def test_main_function_json_output(self, mock_print, mock_network_io, mock_disk_io, mock_memory_usage, mock_cpu_usage):
